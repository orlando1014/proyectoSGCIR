				...
				<div class="col-md-12">
					<div class="card">
					  <div class="card-header" id="numpregunta">
					    Pregunta 4: (Inspección de Materiales y equipo)
					  </div>
					  <div class="card-body">
					  	<form enctype="multipart/form-data" name="formulario" id="formulario">
						  	...
						  	<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿Todos los aparejos (poleas+ cable) se encuentran bien fijos y  no se mueven en ninguna dirección.?</h5>
							...
							<div class="row" style="	margin-bottom: 1em;padding: 1em">	
								<div class="col-md-4">
									<a class="btn btn-danger btn-block proceso-pregunta" href="pregunta3.php">	Pregunta Anterior</a>
								</div>
								<div class="col-md-4"></div>
								<div class="col-md-4">
									<a class="btn btn-primary btn-block proceso-pregunta" href="pregunta5.php" >	Siguiente pregunta</a>
								</div>
							</div>
					  	</form>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(4,"Inspección de Materiales y equipo");
