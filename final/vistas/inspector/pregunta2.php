				...
				<div class="col-md-12">
					<div class="card">
					  <div class="card-header" id="numpregunta">
					    Pregunta 2: (Inspección de Materiales y equipo)
					  </div>
					  <div class="card-body">
					  	<form enctype="multipart/form-data" name="formulario" id="formulario">
						  	...
						  	<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿Los  tablones (canes) utilizados para la realización de la plataforma, tienen  un espesor mínimo de 5 cm y 26 cm de ancho sin nudos y sin rajaduras?</h5>
							...
							<div class="row" style="	margin-bottom: 1em;padding: 1em">	
								<div class="col-md-4">
									<a class="btn btn-danger btn-block proceso-pregunta" href="pregunta1.php">	Pregunta Anterior</a>
								</div>
								<div class="col-md-4"></div>
								<div class="col-md-4">
									<a class="btn btn-primary btn-block proceso-pregunta" href="pregunta3.php" id="siguiente">	Siguiente pregunta</a>
								</div>
							</div>
					  	</form>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(2,"Inspección de Materiales y equipo");
