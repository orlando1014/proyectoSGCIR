					...
					<div class="card">
					  ...
					  <div class="card-body">
					  	...
					  	<form action="" enctype="multipart/form-data" name="formulario" id="formulario">
					  		<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿Si hay elementos en mal estado luego del desensamble se han separado y reportado al inspector y este a su vez al director de obra?</h5>
						  ...
						  <div class="row" style="	margin-bottom: 1em;padding: 1em">	
							...
							<div class="col-md-4">
								<a class="btn btn-primary btn-block proceso-pregunta" href="../../procesos/finalizarCuestionario.php">Enviar</a>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(20,"Desensamble");
