				...
				<div class="col-md-12">
					<div class="card">
					  <div class="card-header" id="numpregunta">
					    Pregunta 6: (Inspección de Materiales y equipo)
					  </div>
					  <div class="card-body">
					  	...
					  	<form action="" enctype="multipart/form-data" name="formulario" id="formulario">
					  		<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿ Los grilletes del cable se colocaron  de acuerdo a las instrucciones,y el número de grilletes de 5/8" que se utilizaron es mínimo 3 y se ubicaron en cada lado libre del cabo tanto en la parte inferior como en la superior?</h5>
						  ...
						  <div class="row" style="	margin-bottom: 1em;padding: 1em">	
							<div class="col-md-4">
								<a class="btn btn-danger btn-block proceso-pregunta" href="pregunta5.php" type="button">	Pregunta Anterior</a>
							</div>
							<div class="col-md-4"></div>
							<div class="col-md-4">
								<a class="btn btn-primary btn-block proceso-pregunta" href="pregunta7.php">	Siguiente pregunta</a>
							</div>
						  </div>
					  	</form>
					  <!-- Fin del row botones -->
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(6,"Inspección de Materiales y equipo");
