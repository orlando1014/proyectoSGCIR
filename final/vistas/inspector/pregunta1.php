				...
				<div class="col-md-12">
					<div class="card">
					  <div class="card-header" id="numpregunta">
					    Pregunta 1: (Inspección de Materiales y equipo)
					  </div>
					  <div class="card-body">
					  	...
					  	<form action="" enctype="multipart/form-data" name="formulario" id="formulario">
					  		<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿ Se ha verificado que no hayan cables eléctricos expuestos, obstrucciones que puedan sobrecargar o inclinar el andamio colgante al levantarlo o bajarlo, bordes de techos o aberturas antes de usarlo ?</h5>
						  		...
						  		<div class="col-md-4">
					                ...
					                <div class="form-group" style="margin-top: 1em;text-align: center;">
									    ...
									    <input type="file" class="form-control-file" id="archivo" name="archivo" accept="image/png,image/jpeg" value="imagen.jpg">
						  ...
						  <div class="row" style="	margin-bottom: 1em;padding: 1em">	
							<div class="col-md-4">
								<a class="btn btn-danger btn-block proceso-pregunta" href="cuestionario.php" type="button">	Pregunta Anterior</a>
							</div>
							<div class="col-md-4"></div>
							<div class="col-md-4">
								<a class="btn btn-primary btn-block proceso-pregunta" href="pregunta2.php">	Siguiente pregunta</a>
							</div>
						  </div>
					  	</form>
					  <!-- Fin del row botones -->
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(1,"Inspección de Materiales y equipo");
