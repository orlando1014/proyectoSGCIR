				...
				<div class="col-md-12">
					<div class="card">
					  <div class="card-header" id="numpregunta">
					    Pregunta 3: (Inspección de Materiales y equipo)
					  </div>
					  <div class="card-body">
					  	<form enctype="multipart/form-data" name="formulario" id="formulario">
						  	...
						  	<div class="row">
						  		<div class="col-md-8">
						  			<h5 class="card-title" id="pregunta">¿Las “u” del techo  o de las losas, las abrazaderas de los parapetos, las vigas en voladizo u otros dispositivos de suspensión son capaces de soportar la carga nominal del guinche (brazo + polea) con un factor de seguridad igual a cuatro (4).?</h5>
							...
							<div class="row" style="	margin-bottom: 1em;padding: 1em">	
								<div class="col-md-4">
									<a class="btn btn-danger btn-block proceso-pregunta" href="pregunta2.php">	Pregunta Anterior</a>
								</div>
								<div class="col-md-4"></div>
								<div class="col-md-4">
									<a class="btn btn-primary btn-block proceso-pregunta" href="pregunta4.php" >	Siguiente pregunta</a>
								</div>
							</div>
					  	</form>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".proceso-pregunta").click(function(){
				ProcesosPregunta(3,"Inspección de Materiales y equipo");
